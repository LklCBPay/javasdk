...
import com.lakala.crosspay.client.exception.LklEncryptException;
...
public class LklMsgUtil {
     ...
     * @param <T>        拉卡拉接口业务参数,扩展自父类LklCrossPaySuperRes {@link com.lakala.crosspay.client.entities.LklCrossPaySuperRes}
     * @return
     * @throws LklEncryptException
     */
